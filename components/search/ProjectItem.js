  ...
  return (
    <article className={`${styles.ProjectItem} ${className}`}>
      <a href="#" className={styles.portrait}>
        <img className={styles.mainImage} alt="Project image" src='https://cdn.dribbble.com/users/702789/screenshots/14253234/media/51d990a95e72cbce5128f2b4bc683e01.png?compress=1&resize=280x210'/>
        <div className={styles.hoverActions}>
          <h2 className={styles.description}>He must become greater.</h2>
      ...
      <div className={styles.info}>
        <div className={styles.leftSection}>
          <h3 className={styles.nameUser}>Visual Jams</h3>
